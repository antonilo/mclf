# source from https://github.com/Lasagne/Recipes/blob/master/modelzoo/googlenet.py
...
_mean_values = np.array([104, 117, 123]).reshape((3,1,1))
...
def prepare_image(im):
    ...
    raw_img = np.copy(im).astype('uint8')
    ...
    im = im - _mean_values
    return raw_img, floatX(im[np.newaxis])
